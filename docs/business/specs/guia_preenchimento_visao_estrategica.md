---
name: guia-preenchimento-visao-estrategica
description: Guia de preenchimento do template de Visão Estratégica e Negócio (Volume I). Orienta autores, analistas e gestores na produção de documento coerente, completo e rastreável.
version: 1.0.0
tags: [guide, business, visao-estrategica, llc-pipeline, sgi]
---

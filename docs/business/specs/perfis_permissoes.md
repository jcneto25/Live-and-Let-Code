...
description: Perfis e Permissões do SGI — Matriz de acesso, catálogo de perfis, regras de autorização (RBAC/ABAC), segregação de funções e auditoria de acessos.
version: 1.0.0
tags: [security, rbac, abac, permissions, access-control, llc-pipeline, sgi]
---
...
Este documento define os perfis de acesso, a matriz de permissões, as regras de autorização e o modelo de controle de acesso do **SISTEMA DE GESTÃO DE INVESTIGAÇÕES (SGI)**. O documento serve como referência para:
